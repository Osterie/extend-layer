...
class RestoreBackupDialog extends DomainSpecificGui {
    ...
    createRestoreOptions(Backup) {
        ...
        this.Add("Text", "xp+100 yp w400", "Restores the backup, but keeps your current profiles. This means that your current profiles will not be replaced by the profiles in the backup, if you have edited any or have created your own. An example of a profile is the 'Default' profile")
        ...
        this.Add("Text", "xp+100 yp w400", "Restores the backup and replaces your current profiles with the as they were in this backup. This means that any changes you made to your current profiles after this backup will be lost. (or you can restore them from another backup)")
    }
